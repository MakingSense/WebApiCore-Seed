...
namespace WebApiCoreSeed.Infrastructure.Tests.RestClientTest
{
    public class RestClientTests
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => new RestClient.RestClient(baseUrl, new HttpClient()));
        }
        ...
        {
            // Arrange
            var restClient = new RestClient.RestClient(baseUrl, new HttpClient());
        ...
        public async Task PostAsync_ShouldReturnResourceObject_WhenRequestIsSuccessful()
        {
            ...
            var restClient = new RestClient.RestClient("http://test.com", new HttpClient(mockedResponseHandler));
